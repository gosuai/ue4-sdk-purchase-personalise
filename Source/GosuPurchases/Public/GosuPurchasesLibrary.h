...
public:
	...
	static UGosuPurchasesController* GetPurchasesController(const UObject* WorldContextObject);

	/** Direct access to purchases settings */
	UFUNCTION(BlueprintPure, Category = "GOSU|Common", meta = (WorldContext = "WorldContextObject"))
	static UGosuPurchasesSettings* GetGosuSettings(const UObject* WorldContextObject);

	/** Register game session with provided player id */
	UFUNCTION(BlueprintCallable, Category = "GOSU|Events", meta = (WorldContext = "WorldContextObject"))
	static void RegisterSession(const UObject* WorldContextObject, APlayerController* PlayerController, const FString& PlayerId);

	/** Register game session while using SteamOnlineSubsystem */
	UFUNCTION(BlueprintCallable, Category = "GOSU|Events", meta = (WorldContext = "WorldContextObject"))
	static void RegisterSteamSession(const UObject* WorldContextObject, APlayerController* PlayerController);
	...
	static void RegisterStoreOpened(const UObject* WorldContextObject);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GOSU|Purchases|Events", meta = (WorldContext = "WorldContextObject"))
	static void CallShowcaseItemShow(const UObject* WorldContextObject, ERecommendationScenario Scenario, const FString& StoreCategory, const FString& ItemSKU, const FString& ItemName, float Price, const FString& Currency, const FString& Description = TEXT("(optional)"));

	/** (optional) Item was hidden at store page */
	UFUNCTION(BlueprintCallable, Category = "GOSU|Purchases|Events", meta = (WorldContext = "WorldContextObject"))
	static void CallShowcaseItemHide(const UObject* WorldContextObject, ERecommendationScenario Scenario, const FString& StoreCategory, const FString& ItemSKU);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GOSU|Purchases|Events", meta = (WorldContext = "WorldContextObject"))
	static void CallItemDetailsShow(const UObject* WorldContextObject, ERecommendationScenario Scenario, const FString& StoreCategory, const FString& ItemSKU, const FString& ItemName, float Price, const FString& Currency, const FString& Description = TEXT("(optional)"));

	/** (optional) Item details window was closed */
	UFUNCTION(BlueprintCallable, Category = "GOSU|Purchases|Events", meta = (WorldContext = "WorldContextObject"))
	static void CallItemDetailsHide(const UObject* WorldContextObject, ERecommendationScenario Scenario, const FString& StoreCategory, const FString& ItemSKU);

	/** Player triggered purchase process for item */
	UFUNCTION(BlueprintCallable, Category = "GOSU|Purchases|Events", meta = (WorldContext = "WorldContextObject"))
	static void CallPurchaseStarted(const UObject* WorldContextObject, const FString& ItemSKU);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GOSU|Purchases|Events", meta = (WorldContext = "WorldContextObject"))
	static void CallPurchaseCompleted(const UObject* WorldContextObject, const FString& ItemSKU, EInAppPurchaseState::Type PurchaseState, const FString& TransactionID = TEXT(""));
	...
	static void FetchRecommendations(const UObject* WorldContextObject, ERecommendationScenario Scenario, const FString& StoreCategory, const FOnReceiveRecommendation& SuccessCallback, int32 MaxItems = 20);
	...
	static TArray<FGosuRecommendedItem> GetRecommendedItems(const UObject* WorldContextObject, ERecommendationScenario Scenario = ERecommendationScenario::Recommended, FString StoreCategory = TEXT(""));
